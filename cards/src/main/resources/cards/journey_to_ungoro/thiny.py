...
file.close()
if heroClass != "ANY":
        src = "C:\\Users\\James Gale\\Documents\\metastone\\cards\\journey_to_ungoro\\" + filename
        dest = "C:\\Users\\James Gale\\Documents\\metastone\\cards\\journey_to_ungoro\\" + heroClass[0] + heroClass[1:].lower() + "\\" + filename
