...
public class ChooseHeroCard extends ReplaceHeroCard implements IChooseOneCard {

	private final BattlecryDesc[] battlecryOptions;
	private final BattlecryDesc battlecryBothOptions;

	public ChooseHeroCard(ChooseHeroCardDesc desc) {
		super(desc);
	...
	public PlayCardAction[] playOptions() {
		...
		for (int i = 0; i < battlecryOptions.length; i++) {
			...
			PlayCardAction option = new PlayReplaceHeroCardAction(getCardReference(), battlecry);
