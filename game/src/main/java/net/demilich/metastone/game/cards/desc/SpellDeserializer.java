...
public class SpellDeserializer implements JsonDeserializer<SpellDesc> {
	...
	public SpellDesc deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
		...
		parseArgument(SpellArg.SPELL_SOURCE, jsonData, spellArgs, ParseValueType.TARGET_REFERENCE);
		...
		parseArgument(SpellArg.EXCESS, jsonData, spellArgs, ParseValueType.TARGET_REFERENCE);
		parseArgument(SpellArg.OBJECT, jsonData, spellArgs, ParseValueType.OBJECT);
