...
public enum GameNotification {
	...
	//MY STUFF WOOT WOOT
	COMMIT_MULTIPLAYER_CONFIG,
	MUlTIPLAYER_MODE_SELECTED,

	REPLY_FROM_SERVER_PROMPT_FOR_MULLIGAN,
	REPLY_FROM_SERVER_PROMPT_FOR_ACTION,

	/*
    CLIENT_PROMPT_FOR_MULLIGAN,
	CLIENT_PROMPT_FOR_ACTION,
	CLIENT_GAME_STATE_UPDATE,
	CLIENT_GAME_STATE_LATE_UPDATE,
	*/
	SERVER_PROMPT_FOR_MULLIGAN,
	SERVER_PROMPT_FOR_ACTION,
	SERVER_GAME_STATE_UPDATE,
	SERVER_GAME_STATE_LATE_UPDATE,
}
